...
// en caso contrario, el valor recibido sera {null}
const RepartidorForm = ({ getRepartidores, objRepartidor,setObjRepartidor }) => {

  let modoEditar = false;
  let select = "";

  // si el objetoRepartidor no es null

  if (objRepartidor) {
    modoEditar = true;
    select= objRepartidor.rep_est
  }
        ...
        <form className="row" onSubmit={handleSubmit(enviarFormulario)}>
          <div className="form-group col-md-3">
            ...
            <input type="text" name="rep_nom"
              ...
              defaultValue={objRepartidor ? objRepartidor.rep_nom : ""} />
          ...
          <div className="form-group col-md-3">
            ...
            <input type="text" name="rep_ape"
              className="form-control" ref={register({ required: true })}
              defaultValue={objRepartidor ? objRepartidor.rep_ape : ""} />
          ...
          <div className="form-group col-md-3">
            ...
            <select className="form-control" name="rep_est"
              ref={register({ required: true })}
               defaultValue={objRepartidor ? objRepartidor.rep_est: ""}>
          ...
          <div className="form-group col-md-3">
            ...
            <input type="text" name="rep_dni"
              ...
              defaultValue={objRepartidor ? objRepartidor.rep_dni : ""} />
