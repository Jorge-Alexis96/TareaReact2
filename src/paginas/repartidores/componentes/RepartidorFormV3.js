...
const RepartidorFormV3 = ({ getRepartidores, objRepartidor, setObjRepartidor }) => {
///////////
        ...
        <form className="row" onSubmit={handleSubmit(enviarFormulario)}>
          <div className="form-group col-md-3">
            ...
            <input type="text" name="rep_nom"
              ...
              defaultValue={formulario.rep_nom} />
          ...
          <div className="form-group col-md-3">
            ...
            <input type="text" name="rep_ape"
              ...
              defaultValue={formulario.rep_ape} />
          ...
          <div className="form-group col-md-3">
            ...
            <select className="form-control" name="rep_est"
              ref={register({ required: true })}
              defaultValue={formulario.rep_est}>
          ...
          <div className="form-group col-md-3">
            ...
            <input type="text" name="rep_dni"
              ...
              defaultValue={formulario.rep_dni} />
...
export default RepartidorFormV3
